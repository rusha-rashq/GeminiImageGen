...
prompts = [
    "A dramatic portrait of an old man, taken with a Sony Alpha, HDR, natural lighting",
    "A street in New York City, taken with a fisheye lens, wide-angle perspective",
    "A serene beach at sunset, dramatic backlight.",
    "A majestic lion in the savannah, captured from a low-angle perspective, emphasizing its power and dominance.",
    "An extreme close-up shot of a sunflower, showing intricate details of the petals and center",
    "A wide shot of a sunflower field, capturing the vastness and surrounding landscape",
]
